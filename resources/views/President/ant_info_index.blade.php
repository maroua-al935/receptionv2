...
<div class="container w-full">
    <div class="w-3/4 bg-white px-4 py-4 rounded-lg">
        ...
        <div class="mb-12">
            <a href="{{ route('i_visitors_ant') }}"><input class="w-24 bg-red-600 hover:bg-red-700 rounded-lg text-white font-semibold float-right px-2 py-2" type="button" value="Retour"></a>
        </div>
        </div>
    </div>
</div>
