    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            ...
            <div class="my-2 flex sm:flex-row flex-col">
                <form action="{{ route('users.index') }}" method="GET" class="flex flex-row mb-1 sm:mb-0">
                    <div class="relative">
                    ...
                    <div class="sm:ml-2">
                        <button type="submit"
                            class="btn btn-primary inline-block px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600">Search</button>
                    </div>
                </form>
                <div class="sm:ml-auto">
                    <a href="{{ route('users.create') }}"
                        class="btn btn-primary inline-block px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-600">Add
                        User</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900">
                                            {{ $user->service_labels ?: 'N/A' }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900">
                                            {{ $user->antenne_labels ?: 'N/A' }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
